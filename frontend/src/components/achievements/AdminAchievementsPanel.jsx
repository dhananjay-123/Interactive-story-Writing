...
const panel = { background: 'rgba(var(--panel-rgb),var(--pa02))', border: '1px solid rgba(var(--panel-rgb),var(--pa08))', borderRadius: '6px' }
const inputStyle = { background: 'rgba(var(--panel-rgb),var(--pa04))', border: '1px solid rgba(var(--panel-rgb),var(--pa10))', borderRadius: '3px', padding: '8px 14px', color: 'var(--parchment)', fontSize: '14px', outline: 'none', fontFamily: 'inherit' }
const chip = (on) => ({ padding: '7px 14px', fontSize: '12px', letterSpacing: '0.06em', textTransform: 'uppercase', border: `1px solid ${on ? 'var(--gold)' : 'rgba(var(--panel-rgb),var(--pa12))'}`, background: on ? 'rgba(var(--gold-rgb),0.1)' : 'transparent', color: on ? 'var(--gold)' : 'rgba(var(--text-rgb),var(--ta50))', cursor: 'pointer', borderRadius: '3px', fontFamily: 'inherit' })
const miniBtn = (on) => ({ padding: '5px 10px', fontSize: '11px', border: `1px solid ${on ? 'var(--gold)' : 'rgba(var(--panel-rgb),var(--pa12))'}`, background: on ? 'rgba(var(--gold-rgb),0.12)' : 'transparent', color: on ? 'var(--gold)' : 'rgba(var(--text-rgb),var(--ta55))', borderRadius: '3px', cursor: 'pointer', fontFamily: 'inherit' })
const primaryButton = (disabled) => ({ padding: '8px 18px', fontSize: '12px', fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', border: 'none', background: 'var(--gold)', color: 'var(--on-gold)', borderRadius: '3px', cursor: disabled ? 'default' : 'pointer', opacity: disabled ? 0.5 : 1, fontFamily: 'inherit' })
const dangerButton = (disabled) => ({ padding: '8px 18px', fontSize: '12px', fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', border: '1px solid rgba(139,26,46,0.5)', background: 'rgba(139,26,46,0.15)', color: '#c45a6e', borderRadius: '3px', cursor: disabled ? 'default' : 'pointer', opacity: disabled ? 0.5 : 1, fontFamily: 'inherit' })
